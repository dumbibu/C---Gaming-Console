...
{
    public partial class PvETicTacToe : Form, TicTacToeInterface
    {
        int cond = 1;
        public void ButtonsPlaceHolder(int btno)
        {
            if (Buttons()[btno].Text == "O" || Buttons()[btno].Text == "X")
            {
                return;
            }
            else if (Chkwin() == true)
            ...
            if (cond % 2 != 0)
            {
                Buttons()[btno].ForeColor = System.Drawing.Color.Red;
                Buttons()[btno].Text = "X";
                cond++;
                if (Chkwin() == true)
                {
                ...
                if (cond % 2 == 0)
                {
                    ...
                    {
                        int ran = Rnumber();
                        if (Buttons()[ran].Text == "O" || Buttons()[ran].Text == "X")
                        {
                            continue;
                        }
                        else
                        {
                            Buttons()[ran].ForeColor = System.Drawing.Color.Blue;
                            Buttons()[ran].Text = "O";
                            cond++;
                            if (Chkwin() == true)
                            {
